...
- a4b9391: Add `selectedOnTextSelection` option to node view renderers. When enabled, the `selected` prop also becomes true when a TextSelection is fully inside the node's range, not only on NodeSelection.
- Updated dependencies [a4b9391]
  - @tiptap/core@3.22.5
  - @tiptap/pm@3.22.5
...
- a4b9391: Fix duplicate `onUpdate` invocation per document change in the `TableOfContents` extension.
- Updated dependencies [a4b9391]
  - @tiptap/core@3.22.5
  - @tiptap/pm@3.22.5
